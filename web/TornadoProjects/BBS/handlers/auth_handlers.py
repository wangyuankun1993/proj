...
# Project Name: BBS
# File Name: auth_handlers
# Date: 2022/01/14 15:14:58
# Author: wangyuankun
# Function: This file is to achieve user register function!
import base64
import uuid
import hashlib
...
class LoginHandler(BaseHandler):
    ...
    def post(self, *args, **kwargs): # 登录数据提交
        ...
        username = self.get_argument('username','') # 接受用户名参数
        password = self.get_argument('password','') # 接受密码参数
        # 检测验证码是否正确
