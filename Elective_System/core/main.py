...
# File Name: main.py
# Date: 2021/5/26 23:47:03
# Author: wangyuankun
# Function: This file is to achieve main foo !
...
class School(DataBase):
    ...
    def create_teacher(cls):
        ...
        password = input('创建密码：')
        obj_teacher = Teacher(name, school, password)
...
class Teacher(DataBase):
    ...
    def class_begin(self):
        ...
        time.sleep(1)
        print(f'\033[32m上课结束\n{self.name}老师工资加100元，当前工资{self.salary}元\n'
...
class Student(DataBase):
    ...
    def create_student(cls):
        ...
        school = input('输入学校名：')
        password = input('输入密码：')
        obj_stu = Student(name, school, password)
